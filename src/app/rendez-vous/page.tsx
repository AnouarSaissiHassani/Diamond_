              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="mb-5">
                    ...
                    <select
                      {...register("soin", { required: "Veuillez sélectionner un soin" })}
                      className={inputClass}
                    ...
                    {errors.soin && (
                      <p className="text-red-400 text-xs mt-1">{errors.soin.message}</p>
                    )}
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-3 px-8 py-4 text-white transition-colors duration-300 hover:bg-stone-700"
                    style={{
